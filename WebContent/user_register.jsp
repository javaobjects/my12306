...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
  <form action="<%=request.getContextPath()%>/UserServlet" method="post">
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td colspan="2" background="images/ny_top_img_bg.gif"><img src="images/ny_top_img.gif" width="650" height="108">
        </td>
      </tr>
      <tr>
              ...
              <td colspan="2">
                ...
                <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td align="left" class="text_cray1"><input name="password" type="text" class="text_cray"
                        id="textfield3" /></td>
                  ...
                  <tr>
                    ...
                    <td align="left" class="text_cray1"><input name="confirm_password" type="text" class="text_cray"
                        id="textfield4" /></td>
                ...
                <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td height="35" colspan="3" align="left"><input name="textfield2" type="text" class="text_cray"
                        id="textfield2" /></td>
                  </tr>
                  <tr>
                    <td width="19" align="center" class="text_red1"><span class="text_red">*</span></td>
                  ...
                  <tr>
                    ...
                    <td height="35" colspan="3" align="left"><input name="birthday" type="date" class="text_cray"
                        id="textfield7" /></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td height="50" colspan="3" align="left" valign="middle" class="text_cray1">
                      ...
                      我已阅读并同意遵守 <a href="/otn/regist/rule;jsessionid=FA97B306AACF75E37DD4D10CFD59994A" class="ft14"
                        target="_blank" shape="rect"> 《中国铁路客户服务中心网站服务条款》</a></td>
                  </tr>
                </table> <br>
                <table width="835" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="234">&nbsp;</td>
                    <td width="147" height="30" align="center"><input name="button3" type="submit" class="buttj"
                        id="button3" value=""></td>
                    <td width="141" align="center">&nbsp;</td>
                    <td width="147" align="center"><input name="button4" type="submit" class="butcz" id="button4"
                        value=""></td>
